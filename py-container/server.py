...
|                                               |    def __init__(self):
|\label{lst:container:servant:dict:python}      |        self.proxies = dict()
|                                               |
|                                               |    def link(self, key, proxy, current=None):
|\label{lst:container:servant:already:python}   |        if key in self.proxies:
...
|\label{lst:container:servant:NoSuchKey:python} |        if not key in self.proxies:
